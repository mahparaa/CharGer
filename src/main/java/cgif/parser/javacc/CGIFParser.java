...
/** The main class for parsing CGIF. 
    The parser that is generated by javacc, based on the *.jj token/grammar productions file.
    See cgif07.jj for the originating productions and methods.
*/
...
label.append(first.image);
        first.image = label.toString();
...
label.append(first.image);
      ...
      default:
        jj_la1[5] = jj_gen;
// create a dummy token to satisfy compiler
        first = new Token();
        first.image = "";
        {if ("" != null) return first;}
      }
...
{if ("" != null) return d.image;}
  ...
  private boolean jj_2_4(int xla)
 {
  ...
  private boolean jj_3R_referent_385_5_16()
 {
    if (jj_3R_setReferent_511_5_17()) return true;
    return false;
  }

  private boolean jj_3R_referent_360_5_13()
 {
    if (jj_scan_token(IDENTIFIER)) return true;
    return false;
  }

  private boolean jj_3R_typelabel_310_5_6()
 {
    Token xsp;
    xsp = jj_scanpos;
    if (jj_3R_typelabel_310_5_8()) {
    jj_scanpos = xsp;
    if (jj_3R_typelabel_318_5_9()) {
    jj_scanpos = xsp;
    if (jj_3R_typelabel_326_5_10()) return true;
    }
    }
    return false;
  }

  private boolean jj_3R_typelabel_310_5_8()
 {
    if (jj_scan_token(IDENTIFIER)) return true;
    return false;
  }
  ...
  private boolean jj_3_2()
 {
    ...
    if (jj_3R_typelabel_310_5_6()) return true;
    Token xsp;
    xsp = jj_scanpos;
    if (jj_3R_concept_288_36_7()) jj_scanpos = xsp;
  ...
  private boolean jj_3_4()
 {
  ...
  private boolean jj_3R_referent_376_5_15()
 {
    Token xsp;
    xsp = jj_scanpos;
    if (jj_scan_token(29)) {
  ...
  private boolean jj_3R_referent_351_5_12()
 {
    if (jj_scan_token(STAR)) return true;
    return false;
  }

  private boolean jj_3R_setReferent_511_5_17()
 {
    if (jj_scan_token(LBRACE)) return true;
    return false;
  }

  private boolean jj_3R_typelabel_326_5_10()
 {
    return false;
  }

  private boolean jj_3R_referent_368_5_14()
 {
    if (jj_scan_token(QUOTED_STRING)) return true;
    return false;
  }

  private boolean jj_3R_concept_288_36_7()
 {
    if (jj_scan_token(COLON)) return true;
    if (jj_3R_referent_341_5_11()) return true;
    return false;
  }

  private boolean jj_3R_referent_341_5_11()
 {
    Token xsp;
    xsp = jj_scanpos;
    if (jj_3_3()) {
    jj_scanpos = xsp;
    if (jj_3R_referent_351_5_12()) {
    jj_scanpos = xsp;
    if (jj_3R_referent_360_5_13()) {
    jj_scanpos = xsp;
    if (jj_3R_referent_368_5_14()) {
    jj_scanpos = xsp;
    if (jj_3R_referent_376_5_15()) {
    jj_scanpos = xsp;
    if (jj_3R_referent_385_5_16()) return true;
    }
    }
    }
    }
  ...
  private boolean jj_3R_typelabel_318_5_9()
 {
    if (jj_scan_token(QUOTED_STRING)) return true;
    return false;
  }
